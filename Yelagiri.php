                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tour__overview__wrap">
                            <h2 class="section__title__3">Black Sand Beach</h2>
...
The beach is known for its beautiful sunsets in the evenings and the break-taking view of the Sea. It’s ideal for people who are looking to enjoy calm and peaceful time</p>
                                    </div>
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                        <img src="images/tour-details/70.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/69.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/68.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/67.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__dewtails">
                                        ...
                                        <p>Historians say Tilmati was popular during the reign of the Marathas in the region. Later, it turned out to be on the border of North Canara and Goa, ruled by the British and Portuguese respectively before Independence. Due to its location, it was an important trade spot also.</p>
                                    </div>
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/66.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
