                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tour__overview__wrap">
                            <h2 class="section__title__3">Nandi Hills</h2>
                            <div class="tour__overview__inner">
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/09.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__dewtails">
                                        ...
                                        <p>Nandi Hills (Anglicised forms include Nandidurg and Nandydoorg) is an ancient hill fortress built by Ganga Dynasty and later enlarged and strengthened by Tipu Sultan in southern India, in the Chikkaballapur district of Karnataka state. It is 10 km from Chickballapur town and approximately 60 km from Bengaluru. .</p>
                                    </div>
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/08.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__dewtails">
                                        ...
                                        <p>Nandi Hills is a destination for hiking and trekking for beginners to intermediate level. Trails in the area include the staircase-based trekking path which starts near Sultanpet village.</p>
                                    </div>
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/07.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/06.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
