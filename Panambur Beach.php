                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="tour__overview__wrap">
                            <h2 class="section__title__3">Panambur Beach</h2>
...
The beach is known for its beautiful sunsets in the evenings and the break-taking view of the Sea. It’s ideal for people who are looking to enjoy calm and peaceful time</p>
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/21.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/19.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
                                ...
                                <div class="single__overview">
                                    ...
                                    <div class="overview__thumd">
                                        <div class="overview__inner">
                                            <img src="images/tour-details/20.jpg" alt="overview images">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Overview -->
