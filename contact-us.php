            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="our__information__team clearfix mt-50 xs--mt--10">
                        <!-- Start Single Staf -->
                        <div class="col-md-offset-4 col-md-4 col-lg-4 hidden-sm col-xs-12 col-md-offset-4">
                            <div class="information__inner text-center">
                                <div class="information__thumb">
                                    <img src="images/contact-info-img/map.png" alt="information images">
                                </div>
                                <div class="information_details">
                                    <h4><a href="#">IYYAPPAN</a></h4>
                                    <h6>Manager</h6>
                                    <p><i class="zmdi zmdi-phone-paused"></i>Phone :<a href="phone:+91 8072151335">+91 8072151335</a></p>
                                    <p><i class="zmdi zmdi-email"></i><a href="mailto:info@travelbliss.com">info@travelbliss.com</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Staf -->
        ...
        <div class="map-contacts">
            ...
            <div class="map__hover__info">
                <div class="map__hover__inner">
                    ...
                    <h4 class="text-theme">Travel Bliss</h4>
                    <p>India</p>
                    <div class="single__find__address">
                        <p><a href="mailto:info@travelbliss.com">info@travelbliss.com</a></p>
                    </div>
                    <div class="single__find__address">
                        <p><a href="phone:+91 8072151335">+91 8072151335</a></p>
                    </div>
             </div>
            </div>
         </div>
